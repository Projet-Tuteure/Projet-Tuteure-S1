...
<html lang="fr" dir="ltr" class="h-100">
    ...
    <body class="h-100">
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top">
            <a class="text-white mr-3" href="#">Accueil</a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a class="btn btn-outline-success" href="contact/index.php">Contact</a>
            </div>
        </nav>
        ...
        <div class="card w-75 mx-auto mb-3">
            <div class="card-body">
                <h3 class="card-title">Titre de la partie</h3>
                <h4 class="card-subtitle mb-2 text-muted">Titre sous partie</h4>
