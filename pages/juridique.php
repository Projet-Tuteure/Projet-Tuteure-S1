<?php include "header.php"; ?>
    ...
    <div class="card w-75 mx-auto mb-3 card_content">
      <div class="card-body">
        <h3 class="card-title">Les lois régissants la bourse</h3>
        <h4 class="card-subtitle mb-2 text-muted">Délit d'initié</h4>
        <p class="card-text">Certains inverstisseurs en valeur immobilière se servent d'informations confidentielles pour augmenter leurs gains lors de transactions financières. Il se sépare en deux catégories :<br />
            - Le délit d'initié direct : L'information est obtenue par un membre de l'entreprise.<br />
        ...
        La société IG Market à reçu une amende de 500.000€ en 2018 pour avoir vendu des CFD perdants à des clients.
        </p>
        <h4 class="card-subtitle mb-2 text-muted">Les options binaires</h4>
