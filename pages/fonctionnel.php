    ...
    <div class="card-body">
        ...
        <div class="row">
            <figure class="col-md-6">
                <img src="assets/trading_avant.jpg" alt="Salle de trading avant" width="600px" class="img-fluid"/>
                <figcaption class="text-center"><em>Salle de trading avant la digitalisation</em></figcaption>
            </figure>
            <figure class="col-md-6">
                <img src="assets/salle_trading.jpg" alt="Salle de trading de nos jours" width="600px" class="img-fluid"/>
                ...
                <div class="maincontainer">
                    <div class="thecard">
                        <div class="thefront">
                            ...
                            <img src="assets/Broker.png" style="border-radius: 10px;" alt="Image de Leonardo Dicaprio dans 'Le loup de Wall Street'" class="img-thumbnail"/>
                            <p></p>
                        </div>
            ...
            <div class="col">
                <div class="maincontainer">
                    <div class="thecard">
                        <div class="thefront">
                            <h4>Les Traders</h4>
                            <img src="assets/trader.jpg" alt="image de Trader" class="img-thumbnail"/>
                            <p>
            ...
            <div class="col">
                <div class="maincontainer">
                    <div class="thecard">
                        <div class="thefront">
                            <h4>Techniciens</h4>
                            <img src="assets/Backoffice.jpg" alt="image de S.A.V." class="img-thumbnail"/>
                            <p></p>
                        </div>
                        <div class="theback">
                            <h5 class="card-subtitle mb-2 text-muted pt-5">Description du poste :</h5>
                            <p>
