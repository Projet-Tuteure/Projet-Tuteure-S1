    ...
    <div class="card-body">
        ...
        <div class="row">
            <figure class="col-md-6">
                <img src="assets/trading_avant.jpg" alt="Salle de trading avant" width="600px" class="img-fluid rounded mx-auto d-block"/>
                <figcaption class="text-center"><em>Salle de trading avant la digitalisation</em></figcaption>
            </figure>
            <figure class="col-md-6">
                <img src="assets/salle_trading.jpg" alt="Salle de trading de nos jours" width="600px" class="img-fluid rounded mx-auto d-block"/>
                <figcaption class="text-center"><em>Salle de trading de nos jours.</em></figcaption>
            </figure>
        </div>
...
<div class="card w-75 mx-auto mb-3 card_content accordion" id="accordionExample">
    <div class="card-body">
                    ...
                    <div class="thecard">
                        ...
                        <div class="theback pt-5">
                            <p>
                                ...
                                </br><a href="https://www.ig.com/fr" target="_blank">IG</a>
                                </br><a href="https://www.boursorama-banque.com/bourse/" target="_blank">Boursorama</a>
                    ...
                    <div class="thecard">
                        ...
                        <div class="theback pt-5">
                            <p>
                                ...
                                </br>Gestionnaire titres règlement/livraison
    ...
    <div class="card-body">
        ...
        <div class="row">
            <figure class="col-md-4">
                <img src="assets/THF.jpg" alt="Trading Haute Frequence image" class="image-fluid w-100 rounded"/>
                <figcaption class="text-center"><em>La numérisation des activités de Trading</em></figcaption>
            </figure>
            <div class="col-md-8">
        ...
        <div class="row align-items-center">
            <div class="col-md-8">
                <h4 class="card-subtitle mb-2 mt-3 text-muted">Le Smart Beta</h4>
        ...
        <div>
            <em>Toutes les images ont été pris sur <a href="https://www.google.fr" target="_blank">Google-image.fr</a></em>
        </div>
    </div>
</div>
